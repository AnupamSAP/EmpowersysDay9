		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comempempproject9-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comempempproject9-display": {
								"semanticObject": "comempempproject9",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.emp.empproject9",
									"url": sap.ui.require.toUrl("com/emp/empproject9")
								}
							}
						}
					}
